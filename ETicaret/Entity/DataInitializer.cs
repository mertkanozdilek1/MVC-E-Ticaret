...
namespace ETicaret.Entity
{
    ...
    { 
        ...
        protected override void Seed(DataContext context)
        {
            ...
            var cart = new List<CreditCart>()
         {
             new CreditCart(){CartName="Axess"},
              new CreditCart(){CartName="Ziraat"},
               new CreditCart(){CartName="YapıKredi"},
            ...
            foreach (var credit in cart)
            {
                context.CreditCarts.Add(credit);
            }
            context.SaveChanges();
